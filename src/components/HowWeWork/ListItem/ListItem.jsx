...
import { ListLi, Wrapper, Number, ContainerBlock, InfoBlock, Text, HiddenText, Button, PlusSvg, CloseSvg, Thumb, Image, PlayerWrapper, StyledPlayer } from './ListItem.styled';
   ...
   if (id === '01') {
    ...
    return (
        <ListLi>
            ...
            {isTextShown && isNarrowScreen && ( isVideo ?  <PlayerWrapper>
                <StyledPlayer
                  url='https://res.cloudinary.com/deqdv9pvd/video/upload/v1697474178/Video%20for%20website/2023-10-16_07.47.10_jzcwnu.mp4'
                  controls
                />
        </PlayerWrapper> :
          <Thumb><Image $tabletphoto={tabletPhoto} src={mobilePhoto} alt="how we work" /></Thumb>)}
        </ListLi>
    )
}
